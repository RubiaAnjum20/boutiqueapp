...
import 'package:boutiqueapp/Components/CustomSVG/custom_svg.dart';
...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    final Color textColor = widget.textColor ?? AppColors.textColor;
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: widget.hintStyle ??
                  appTheme.bodySmall!
                      .copyWith(color: AppColors.greyIconColor, height: 1.5),
              disabledBorder: widget.inputBorder ??
                  OutlineInputBorder(
                      borderSide: BorderSide(
                    width: 2,
                    color: AppColors.greyIconColor.withOpacity(0.5),
                  )),
